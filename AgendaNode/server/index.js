...
const http = require('http'); //requerir el módulo http
      path = require('path'), //requerir el modulo path para trabajar con directorios
      ...
      MongoClient = require('mongodb').MongoClient, //Requerir el módulo modngodb
      mongoose = require('mongoose'), //Requerir el módulo modngoose para crear esquemas y modelos de base de datos.
...
app.use(session({ //Iniciar módulo de manejo de sesiones
