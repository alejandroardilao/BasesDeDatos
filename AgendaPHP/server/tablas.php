...
//Iniciar la función crear tabla con la información del objeto Usuarios
...
//Iniciar la función crear tabla con la información del objeto Eventos
...
if($response['eventos'] =='OK' AND $response['usuarios'] == 'OK' ){ //Si las tablas evento y usuarios se encuentran en la base de datos
  ...
  $result =  $con->nuevaRelacion($eventos->nombreTabla, $usuarios->nombreTabla, 'fk_usuarioemail_evento', 'fk_usuarios', 'email'); //nombre de la tabla origen, nombre tabla destino, nombre de la clave foránea, nombre de la columna origen, nombre de columna destino
  if( $result == "OK"){
