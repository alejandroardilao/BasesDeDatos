...
$con = new ConectorBD();
if(  $con->initConexion($con->database) == 1049){ //Verificar si no existe la base de datos al comparar que la respuesta del servidor sea igual a 1049 (base de datos desconocida)
