...
if($response['conexion'] == 'OK'){
    ...
    $data['hora_inicio'] = '"'.$_POST['start_hour'].':00"';/*adicionar ":00" para completar formato de fecha*/
    $data['fecha_fin'] = '"'.$_POST['end_date'].'"';
    $data['hora_fin'] = '"'.$_POST['end_hour'].':00"'; /*adicionar ":00" para completar formato de fecha*/
